...
ComplexMonoAudioWidget::ComplexMonoAudioWidget(QWidget *parent)
    : QWidget(parent)
{
...
ComplexMonoAudioWidget::~ComplexMonoAudioWidget()
{
}

void ComplexMonoAudioWidget::dataSource_dataChanged()
{
    m_timeProvider->setSampleRate(m_audioWidget->dataSource()->sampleRate());
    audioWidget_geometryChanged(m_audioWidget->geometry());
}

void ComplexMonoAudioWidget::audioWidget_geometryChanged(
...
void ComplexMonoAudioWidget::scrollBar_valueChanged(int value)
{
...
bool ComplexMonoAudioWidget::eventFilter(QObject *obj, QEvent *event)
{
