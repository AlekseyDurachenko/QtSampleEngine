...
#ifndef QSEABSOLUTEMETRICPROVIDER_H
#define QSEABSOLUTEMETRICPROVIDER_H

#include "qseabstractmetricprovider.h"
#include "qsemetricmapper.h"


class QseAbsoluteMetricProvider : public QseAbstractMetricProvider
{
    Q_OBJECT
public:
...
#endif // QSEABSOLUTEMETRICPROVIDER_H
