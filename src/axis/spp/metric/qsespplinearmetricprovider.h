...
class QseSppLinearMetricProvider : public QseAbstractSppMetricProvider
{
    Q_OBJECT
    Q_ENUMS(Orientation)
public:
...
double QseSppLinearMetricProvider::factor() const
{
    return m_factor;
}

QseSppLinearMetricProvider::Orientation QseSppLinearMetricProvider::orientation() const
{
