...
#ifndef QSESTANDARDHORIZONTALCONTROLLER_H
#define QSESTANDARDHORIZONTALCONTROLLER_H


#include "qseabstractstandardcontroller.h"


class QseStandardHorizontalController : public QseAbstractStandardController
{
    Q_OBJECT
public:
    explicit QseStandardHorizontalController(QObject *parent = 0);
...
#endif // QSESTANDARDHORIZONTALCONTROLLER_H
