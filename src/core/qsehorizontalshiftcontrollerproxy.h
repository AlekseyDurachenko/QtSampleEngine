...
#ifndef QSEHORIZONTALSHIFTCONTROLLERPROXY_H
#define QSEHORIZONTALSHIFTCONTROLLERPROXY_H


#include "qseabstractcontrollerproxy.h"


class QseHorizontalShiftControllerProxy : public QseAbstractControllerProxy
{
    Q_OBJECT
public:
    explicit QseHorizontalShiftControllerProxy(QObject *parent = 0);
...
#endif // QSEHORIZONTALSHIFTCONTROLLERPROXY_H
