...
QseVerticalAxisWidget::QseVerticalAxisWidget(QWidget *parent)
    : QseAbstractAxisWidget(parent)
{
    m_alignment = AlignRight;
}

void QseVerticalAxisWidget::setAlignment(Alignment alignment)
{
...
void QseVerticalAxisWidget::leftRightRender(QPainter *painter)
{
    if (!metricProvider())
        return;
...
void QseVerticalAxisWidget::endModifyTextFont(const QFont &/*font*/)
{
    recalcProviderMinimumSize(metricProvider());
}

void QseVerticalAxisWidget::endModifyMetricProvider(
    QseAbstractMetricProvider */*provider*/)
{
    recalcProviderMinimumSize(metricProvider());
}
