...
#ifndef QSESPPVERTICALAXISWIDGET_H
#define QSESPPVERTICALAXISWIDGET_H

#include "qseabstractsppaxiswidget.h"


class QseSppVerticalAxisWidget : public QseAbstractSppAxisWidget
{
    Q_OBJECT
    Q_ENUMS(Alignment)
...
public:
    ...
    explicit QseSppVerticalAxisWidget(QWidget *parent = 0);
...
QseSppVerticalAxisWidget::Alignment QseSppVerticalAxisWidget::alignment() const
{
    return m_alignment;
}


#endif // QSESPPVERTICALAXISWIDGET_H
