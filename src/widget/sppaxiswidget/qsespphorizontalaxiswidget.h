...
#ifndef QSESPPHORIZONTALAXISWIDGET_H
#define QSESPPHORIZONTALAXISWIDGET_H

#include "qseabstractsppaxiswidget.h"


class QseSppHorizontalAxisWidget : public QseAbstractSppAxisWidget
{
    Q_OBJECT
    Q_ENUMS(Alignment)
...
QseSppHorizontalAxisWidget::Alignment QseSppHorizontalAxisWidget::alignment() const
{
    return m_alignment;
}

int QseSppHorizontalAxisWidget::shift() const
{
    return m_shift;
}


#endif // QSESPPHORIZONTALAXISWIDGET_H
